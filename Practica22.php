...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
       ...
       // Conexión a la base de datos
        ...
        $username = "prograwebitm";        // Cambia esto según tus credenciales
        $password = "root";            // Cambia esto según tus credenciales
        $dbname = "prograwebitm";      // Nombre de la base de datos
